...
URL_DISCORD          = "https://discord.gg/s3WgRBCbG5"
...
DANGEROUS_MANUAL_MANIPULATION_TYPES = (
    DANGEROUS_MANUAL_MANIPULATION_TYPE_OBJECT := "OBJECT",
    DANGEROUS_MANUAL_MANIPULATION_TYPE_MATERIAL := "MATERIAL",
    DANGEROUS_MANUAL_MANIPULATION_TYPE_TM_PROPS := "TM_PROPS",
)
